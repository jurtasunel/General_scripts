...
rawfastq_tag=("CS230275_S13" "CS230277_S22")
...
mkdir ${i}_results
mv ${i}_srtd.bam ${i}_not_aligned.txt ${i}_depth.txt ${i}_depth.pdf ${i}_low_depth_positions.csv ${i}_cns.fasta ${i}_results
# Remove unnecesary files.
rm ${i}_srtd.bam.bai ${i}_cns.fq
